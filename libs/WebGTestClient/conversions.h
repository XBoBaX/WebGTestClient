...
namespace webdriver {
	...
	public:
		...
		T Get(const std::string& name) const {
			...
			WEBDRIVER_CHECK(it != map.end(), detail::Fmt() << "No \"" << name << "\" in JsonObject");
	...
	namespace conversions_detail {
		...
		void FromJsonImpl(const picojson::value& value, T& result, IterableTag) {
			WEBDRIVER_CHECK(value.is<picojson::array>(), "Value is not an array");
	...
	inline
		...
		WEBDRIVER_CHECK(value.is<double>(), "Value is not a number");
	...
	inline
		...
		WEBDRIVER_CHECK(value.is<picojson::object>(), "Size is not an object");
	...
	inline
		...
		WEBDRIVER_CHECK(value.is<picojson::object>(), "Point is not an object");
	...
	inline
		...
		WEBDRIVER_CHECK(value.is<picojson::object>(), "Cookie is not an object");
